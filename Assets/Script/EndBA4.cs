...
public class EndBA4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Bossflip = GameObject.Find("EndBoss (4)");
    ...
    void Update()
    {
        float bossFlipValue = Bossflip.GetComponent<EndBC4>().Bossflip;

        float Bossf = Bossflip.GetComponent<EndBC4>().Bossflip;
