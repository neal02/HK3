...
public class EndBA1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Bossflip = GameObject.Find("EndBoss (1)");
    ...
    void Update()
    {
        float bossFlipValue = Bossflip.GetComponent<EndBC1>().Bossflip;

        float Bossf = Bossflip.GetComponent<EndBC1>().Bossflip;
