...
public class EndBA2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Bossflip = GameObject.Find("EndBoss (2)");
    ...
    void Update()
    {
        float bossFlipValue = Bossflip.GetComponent<EndBC2>().Bossflip;

        float Bossf = Bossflip.GetComponent<EndBC2>().Bossflip;
